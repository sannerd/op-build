...
else ifeq ($(BR2_OPENPOWER_MACHINE_XML_CUSTOM_GITHUB),y)
CUST_GITHUB_VALUE ?= $(call qstrip,$(BR2_OPENPOWER_MACHINE_XML_CUSTOM_GITHUB_VALUE))
MACHINE_XML_SITE = $(call github,$(CUST_GITHUB_VALUE),$(BR2_OPENPOWER_MACHINE_XML_GITHUB_PROJECT_VALUE),$(MACHINE_XML_VERSION))
endif
